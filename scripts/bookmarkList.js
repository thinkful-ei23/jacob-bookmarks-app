...
const bookmarkList = (function() {
  ...
  const changeStarRating = function() {
    $('.js-bookmark-list').on('click', '.js-star5', function(event) {
      let id = $(this).closest('li').data('item-id');
      api.changeRating(id, 5, function(response) {
